...
class User extends Model {
  ...
  static associate(models) {
    this.hasMany(models.UserImage, { foreignKey: 'user_image_fk_user', as: 'user_image' });
    this.belongsToMany(models.UserImage, { foreignKey: 'user_fk_image_path', as: 'user_image' });
  }
}
